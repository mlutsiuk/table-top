...
<template>
  ...
  >
    ...
    <ScrollAreaScrollbar
      class="flex touch-none select-none bg-gray-700 p-0.5 transition-colors duration-[160ms] ease-out hover:bg-gray-600 data-[orientation=vertical]:w-2.5"
      orientation="vertical"
    >
      <ScrollAreaThumb
        class="relative flex-1 rounded-[10px] bg-gray-400 before:absolute before:left-1/2 before:top-1/2 before:size-full before:min-h-[44px] before:min-w-[44px] before:-translate-x-1/2 before:-translate-y-1/2 before:content-['']"
      />
    </ScrollAreaScrollbar>
  </ScrollAreaRoot>
</template>
