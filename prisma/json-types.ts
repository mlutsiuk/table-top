 ...
 *
 * Nothing is declared here — the types live in `shared/types/trait.ts` so the
...
import type {
  ...
  RawTraitConfig as _RawTraitConfig
} from '#shared/types/trait'

declare global {
  namespace PrismaJson {
    type RawTraitConfig = _RawTraitConfig
